...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.menu.about' => 'getApp_Menu_AboutService',
            'app.menu.automation' => 'getApp_Menu_AutomationService',
            'app.menu.contact' => 'getApp_Menu_ContactService',
            'app.menu.it' => 'getApp_Menu_ItService',
            'app.menu.user' => 'getApp_Menu_UserService',
    ...
    /**
     * Gets the 'app.menu.about' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * 
     * @throws InactiveScopeException when the 'app.menu.about' service is requested while the 'request' scope is not active
     */
    protected function getApp_Menu_AboutService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('app.menu.about', 'request');
        }

        return $this->services['app.menu.about'] = $this->scopedServices['request']['app.menu.about'] = $this->get('app.menu_builder')->aboutMenu($this->get('request'));
    }

    /**
     * Gets the 'app.menu.automation' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Knp\Menu\MenuItem A Knp\Menu\MenuItem instance.
     * 
     * @throws InactiveScopeException when the 'app.menu.automation' service is requested while the 'request' scope is not active
     */
    protected function getApp_Menu_AutomationService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('app.menu.automation', 'request');
        }

        return $this->services['app.menu.automation'] = $this->scopedServices['request']['app.menu.automation'] = $this->get('app.menu_builder')->automationMenu($this->get('request'));
    }

    /**
     * Gets the 'app.menu.contact' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Knp\Menu\MenuItem A Knp\Menu\MenuItem instance.
     * 
     * @throws InactiveScopeException when the 'app.menu.contact' service is requested while the 'request' scope is not active
     */
    protected function getApp_Menu_ContactService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('app.menu.contact', 'request');
        }

        return $this->services['app.menu.contact'] = $this->scopedServices['request']['app.menu.contact'] = $this->get('app.menu_builder')->contactMenu($this->get('request'));
    }

    /**
     * Gets the 'app.menu.it' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Knp\Menu\MenuItem A Knp\Menu\MenuItem instance.
     * 
     * @throws InactiveScopeException when the 'app.menu.it' service is requested while the 'request' scope is not active
     */
    protected function getApp_Menu_ItService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('app.menu.it', 'request');
        }

        return $this->services['app.menu.it'] = $this->scopedServices['request']['app.menu.it'] = $this->get('app.menu_builder')->itMenu($this->get('request'));
    }

    /**
     * Gets the 'app.menu.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Knp\Menu\MenuItem A Knp\Menu\MenuItem instance.
     * 
     * @throws InactiveScopeException when the 'app.menu.user' service is requested while the 'request' scope is not active
     */
    protected function getApp_Menu_UserService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('app.menu.user', 'request');
        }

        return $this->services['app.menu.user'] = $this->scopedServices['request']['app.menu.user'] = $this->get('app.menu_builder')->userMenu($this->get('request'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d48c393dc50e18c2dafd0035ac798b16bd2b06176d4497fd00ac17a031e48343');
    ...
    {
        return $this->services['knp_menu.menu_provider'] = new \Knp\Menu\Provider\ChainProvider(array(0 => new \Knp\Bundle\MenuBundle\Provider\ContainerAwareProvider($this, array('about' => 'app.menu.about', 'automation' => 'app.menu.automation', 'it' => 'app.menu.it', 'contact' => 'app.menu.contact', 'user' => 'app.menu.user')), 1 => new \Knp\Bundle\MenuBundle\Provider\BuilderAliasProvider($this->get('kernel'), $this, $this->get('knp_menu.factory'))));
    }
